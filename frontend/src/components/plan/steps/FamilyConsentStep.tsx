    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.subtitle}>
          {members.length > 0
            ? `MockPass returned ${members.length} household member${members.length === 1 ? '' : 's'}. Invite them so the plan can cover the household.`
            : 'MockPass did not return another household member. You can continue with an individual plan.'}
        </Text>
