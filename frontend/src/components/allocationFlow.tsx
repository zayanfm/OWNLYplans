...
export const AllocationFlow: React.FC = () => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        {ALLOC_ROUTES.map((route, index) => {
          ...
          const amtColor = route.color === 'text-green-600' ? '#16A34A' : '#1A1A1A';
          ...
          return (
            <View key={index} style={[styles.routeRow, !isLast && styles.routeBorder]}>
              ...
              <Text style={[styles.routeAmt, { color: amtColor }]}>{route.amt}</Text>
            </View>
          );
        })}
      </View>
